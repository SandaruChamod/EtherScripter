...
<div id="instructions">
    ...
    <ol>
        <li>Download Ganache, a private development blockchain, by visiting <a href="https://trufflesuite.com/ganache" target="_blank">https://trufflesuite.com/ganache</a>.</li>
        <li>Open Ganache and start a new workspace by pointing to your truffle-config.js file in the root directory.</li>
        <li>Compile the smart contract using 'truffle compile'.</li>
        <li>Deploy the smart contract using 'truffle migrate'.</li>
        <li>Go to the 'Accounts' tab in Ganache, copy one of the development addresses, and paste it into the address input.</li>
        <li>Once you press the 'Test Contract' button, you will see that the count value of the smart contract will increase.</li>
